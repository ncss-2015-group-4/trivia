...
cur.execute('INSERT INTO questions VALUES(NULL,"Who killed Snape?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"How many Horcruxes of Voldemort\'s are there?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Who put Harry\'s name in the Goblet of Fire?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"How many unforgivable curses are there?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Who did Hermoine go with to the Yule ball?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"How does Sirius die in Order of the Phoenix?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"What is Voldemort\'s real name?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Who composed the music for the Harry Potter movies?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Which house is Harry Potter in?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"What do Hermoine\'s parents do for a living?",0,0,1,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Who played the 10th Doctor?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"What year was Doctor Who first aired?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Who was the 9th Doctor\'s companion?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Who played the first Doctor?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Who is RTD??",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"What is John Hurt\'s Doctor refered to as?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"Which of these is a spin off series from Doctor Who?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"What planet is The Doctor from?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"What species is The Doctor?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"In what war were the Time Lords killed?",0,0,2,0);')
cur.execute('INSERT INTO questions VALUES(NULL,"What is the best ranked Pokemon?",0,0,2,0);')
